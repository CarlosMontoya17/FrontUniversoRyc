...
@Component({
  selector: 'app-cotizador-nl',
  templateUrl: './cotizador-nl.component.html',
  styleUrls: ['./cotizador-nl.component.css']
})
export class CotizadorNlComponent implements OnInit {
